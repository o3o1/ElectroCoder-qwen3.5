...
if %errorlevel% equ 0 (
    echo 找到gcc编译器
    gcc -Wall -std=c99 task_pll_sag_english.c -lm -o task_pll_sag_english.exe
    if %errorlevel% equ 0 (
        echo 编译成功！
        echo.
        echo 运行程序...
        echo ========================================
        task_pll_sag_english.exe
        echo ========================================
    ) else (
        echo 编译失败
    )
...
if %errorlevel% equ 0 (
    echo 找到clang编译器
    clang -Wall -std=c99 task_pll_sag_english.c -lm -o task_pll_sag_english.exe
    if %errorlevel% equ 0 (
        echo 编译成功！
        echo.
        echo 运行程序...
...
if %errorlevel% equ 0 (
    echo 找到cc编译器
    cc -Wall -std=c99 task_pll_sag_english.c -lm -o task_pll_sag_english.exe
    if %errorlevel% equ 0 (
        echo 编译成功！
        echo.
        echo 运行程序...
