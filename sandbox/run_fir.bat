...
if exist "C:\Python39\python.exe" (
    C:\Python39\python.exe task_fir_highpass.py
) else if exist "C:\Python38\python.exe" (
    C:\Python38\python.exe task_fir_highpass.py
) else if exist "C:\Python37\python.exe" (
    C:\Python37\python.exe task_fir_highpass.py
) else if exist "C:\Python36\python.exe" (
    C:\Python36\python.exe task_fir_highpass.py
) else if exist "C:\Python35\python.exe" (
    C:\Python35\python.exe task_fir_highpass.py
) else if exist "C:\Python34\python.exe" (
    C:\Python34\python.exe task_fir_highpass.py
) else if exist "C:\Python33\python.exe" (
    C:\Python33\python.exe task_fir_highpass.py
) else if exist "C:\Python27\python.exe" (
    C:\Python27\python.exe task_fir_highpass.py
) else (
    echo Python not found! Trying to run without Python...
    echo.
