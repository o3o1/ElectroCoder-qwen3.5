...
int main() {
    ...
    printf("=== PLL Low Power Mode Management Simulation ===\n\n");
    ...
    printf("2. Enable PLL and wait for lock:\n");
    ...
    printf("4. Request wakeup:\n");
    pll_wakeup_request();
    pll_state_machine();
    printf("   Current state: %s\n", pll_state_to_string());
    printf("   PLL_CTRL_REG: 0x%08X\n\n", PLL_CTRL_REG);
    
    printf("5. Complete wakeup process:\n");
    PLL_STATUS_REG |= PLL_WAKEUP_DONE_BIT;
    pll_state_machine();
    printf("   Current state: %s\n", pll_state_to_string());
    printf("   PLL_STATUS_REG: 0x%08X\n", PLL_STATUS_REG);
